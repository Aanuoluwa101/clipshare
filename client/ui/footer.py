...
class Footer:
    def __init__(self, root):
        ...
        self.client_state = tk.Label(
            footer_frame, font=("Helvetica", 8), bg="#2c3e4c", fg="white"
        )
        self.client_state.pack(side="right")

        self.gateway = tk.Label(
            footer_frame, font=("Helvetica", 8), bg="#2c3e4c", fg="white"
        )
